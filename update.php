...
if(isset($_POST['submit'])){
    ...
    if($result){
      ...
      $user=1;
        ...
        $sql="UPDATE `login` SET id='$id', name='$name',email='$email',password='$password' WHERE id=$id";
    $result= mysqli_query($con, $sql);
    if($result){
     $success=1;
...
if($success){
  ...
  Congratualtions!! you have updated your data!
</div>';
}
?>
...
<div class="row">
    ...
    <div class="control-group">
      ...
      <div class="controls">
      <input type="text" id="name" name="name" placeholder="" class="input-xlarge" value="<?php echo $name; ?>">
    ...
    <div class="control-group">
      ...
      <div class="controls">
      <input type="password" id="password" name="password" placeholder="" class="input-xlarge" value="<?php echo $password; ?>">
    ...
    <a href="table.php">View the table</a>
